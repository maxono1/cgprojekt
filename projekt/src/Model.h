...
protected: // protected types
    ...
    struct Material
    {
        Material() : NormalMap(NULL), DiffTex(NULL), DiffColor(1, 1, 1), SpecColor(0.3f, 0.3f, 0.3f), AmbColor(0, 0, 0), SpecExp(10) {}
        Color DiffColor;
        Color SpecColor;
        Color AmbColor;
        float SpecExp;
        const Texture* DiffTex;
        // Hier wurde fuer Aufgab 2
        const Texture* NormalMap; // Hinzugefuegt!!!
    };
    struct Node
    {
